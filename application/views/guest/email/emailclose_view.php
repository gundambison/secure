  ...
  <tbody>
    ...
    <tr>
      <td colspan="2" valign="bottom"><table width="750" border="0" cellspacing="10" cellpadding="10">
        <tbody>
          <tr>
<<<<<<< HEAD:application/views/guest/email/emailclose_view.php
            <td height="279">
			<?=$message;?></td>
=======
            <td>
...
>>>>>>> 63f229f9213cd3f2dc1b1c7a689335c0890b4164:views/member/email/emailAccount_view.php
          </tr>
        </tbody>
      </table>
        <br />
...
$subject = '[SalmaForex] Confirmation to Recover Password';
