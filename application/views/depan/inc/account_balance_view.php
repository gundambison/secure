...
$balance = $userlogin['balance'];//$this->account->balance( $accountid);
?>
            <ul class="list-group text-dark panel-shadow">
			  ...
			  <?=number_format($balance, 2);?></span> <i class="fa fa-money" aria-hidden="true"></i>&nbsp; <span class="text-bold">Balance</span> </li>
            </ul>